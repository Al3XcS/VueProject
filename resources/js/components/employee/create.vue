                ...
                <div class="login-form">
                  ...
                  <form class="user" @submit.prevent="employeeInsert" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            ...
                            <small class="text-danger" v-if="errors.address"> {{ errors.address[0] }} </small>
                             ...
                             <div class="col-md-6">
                            <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter Sallary" v-model="form.sallary">
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-md-6">
                            <input type="date" class="form-control" id="exampleInputFirstName" placeholder="Joining Date" v-model="form.joining_date">
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-md-6">
                            <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Phone Number" v-model="form.phone">
